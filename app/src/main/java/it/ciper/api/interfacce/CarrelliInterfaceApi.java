...
public interface CarrelliInterfaceApi {
    ...
    static List<CartItemAPI> allProducts(CarrelloAPI cart){
        return allProducts(cart.getUsernamecreator(), cart.getCartcod());
    }
    static List<CartItemAPI> allProducts(String apiKey, String cartCod){
        String buf = null;
